    ...
    <div className="container mx-auto px-4">
      ...
      <section className="text-center py-20 sm:py-32">
        ...
        <div className="mt-10 flex flex-col sm:flex-row justify-center gap-4">
          ...
          <a href="/contact" className="bg-gray-200 dark:bg-gray-700 text-[var(--foreground)] font-bold py-3 px-6 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors">
            Me Contacter
          </a>
        </div>
      </section>
      ...
      <FadeIn>
        <section className="py-16 bg-[var(--color-card-background)] rounded-xl shadow-md border border-[var(--color-border)]">
