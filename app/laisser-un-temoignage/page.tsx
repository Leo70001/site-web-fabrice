// src/app/laisser-un-temoignage/page.tsx
'use client';
...
export default function SubmitTestimonialPage() {
    ...
    return (
        <div className="container mx-auto max-w-2xl px-4 py-16 sm:py-24">
            ...
            <form onSubmit={handleSubmit} className="mt-8 space-y-6 bg-white p-8 rounded-lg shadow-md border">
                <div>
                    <label htmlFor="name" className="block font-medium text-gray-800">Votre Prénom et l'initiale de votre nom</label>
                    <input
                        id="name"
                        type="text"
                        value={name}
                ...
                <div>
                    <label htmlFor="text" className="block font-medium text-gray-800">Votre témoignage</label>
                    <textarea
                        id="text"
                        value={text}
