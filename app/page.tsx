  ...
  return (
    <>
      <SEO
        ...
        url="https://www.coupeur-de-feu-magnetiseur-fabrice-lemaitre.fr/"
        ...
        <FadeIn>
          <section className="py-20">
            <div className="max-w-5xl mx-auto px-4">
              ...
              <div className="mt-12 text-center bg-[var(--card_color)] border-l-4 border-[var(--card_border)] text-[var(--card_text)] p-6 max-w-3xl mx-auto rounded-md">
