...
export default function CookieBanner() {
    return (
        <CookieConsent
            ...
            buttonStyle={{ color: '#4e503b', fontSize: '13px', background: '#e1e1e1', borderRadius: '5px' }}
            declineButtonStyle={{ borderRadius: '5px' }}
            expires={150}
        >
            Ce site utilise des cookies pour analyser le trafic et améliorer votre expérience.{" "}
            <Link href="/politique-de-confidentialite" className="text-yellow-300 hover:underline">
                En savoir plus.
            </Link>
        </CookieConsent>
    );
